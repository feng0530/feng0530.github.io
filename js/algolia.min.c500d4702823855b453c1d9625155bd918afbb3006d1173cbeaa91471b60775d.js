document.addEventListener("DOMContentLoaded",function(){const n=function(){const e=instantsearch({indexName:"algolia",searchClient:algoliasearch("Y68VT16ZWI","fe4fd21b7ac9972a70f8e470ca1d3208")});e.addWidgets([instantsearch.widgets.searchBox({container:"#searchbox",placeholder:"搜尋內容..."}),instantsearch.widgets.hits({container:"#hits",templates:{item:e=>{console.log(e);let n=e.permalink,s=e._highlightResult.title.matchedWords.join(","),t="";return e.tags.forEach((e)=>{t+=`<p class="tag">#${e}</p>`}),`
